...
func _init() -> void:
	augment_name = "XP Earn Rate"
	description = "Increase the amount of xp you earn in the future"
...
func setLegendaryRarity() -> bool:
	...
	stats = [
		Globals.Pair.new(AugmentEssentials.StatType.PLAYER_XP_PERCENT, 67.25)
	]
...
func setEpicRarity() -> bool:
	...
	# Globals.Pair.new(AugmentEssentials.StatType, value: int, float, etc)
	stats = [
		Globals.Pair.new(AugmentEssentials.StatType.PLAYER_XP_PERCENT, 42.5)
	]
...
func setRareRarity() -> bool:
	...
	# Globals.Pair.new(AugmentEssentials.StatType, value: int, float, etc)
	stats = [
		Globals.Pair.new(AugmentEssentials.StatType.PLAYER_XP_PERCENT, 25.0)
	]
...
func setUncommonRarity() -> bool:
	...
	# Globals.Pair.new(AugmentEssentials.StatType, value: int, float, etc)
	stats = [
		Globals.Pair.new(AugmentEssentials.StatType.PLAYER_XP_PERCENT, 15.0)
	]
...
func setCommonRarity() -> bool:
	...
	# Globals.Pair.new(AugmentEssentials.StatType, value: int, float, etc)
	stats = [
		Globals.Pair.new(AugmentEssentials.StatType.PLAYER_XP_PERCENT, 10.0)
	]
